...
import { validateEmail } from "../utils/passwordUtils";
...
const Signin = () => {
  ...
  const { login, error: authError, success: authSuccess, clearError, clearSuccess, isAuthenticated } = useAuth();
  const navigate = useNavigate();

  // console.log('Signin:', { authError, isAuthenticated });
