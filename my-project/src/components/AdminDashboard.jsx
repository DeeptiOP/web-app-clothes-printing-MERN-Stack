        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow p-6 flex flex-col items-center">
            <div className="p-3 bg-green-100 rounded-full mb-3">
              <MdInventory className="text-green-600" size={24} />
            </div>
            <span className="text-2xl font-bold text-orange-600">{stats.totalProducts}</span>
          ...
          <div className="bg-white rounded-xl shadow p-6 flex flex-col items-center">
            ...
            <span className="text-2xl font-bold text-orange-600">{stats.totalUsers}</span>
          ...
          <div className="bg-white rounded-xl shadow p-6 flex flex-col items-center">
            ...
            <span className="text-2xl font-bold text-orange-600">₹{stats.totalRevenue.toLocaleString()}</span>
        ...
        <div className="relative">
          ...
          {accountMenuOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-white rounded shadow-lg z-50">
              ...
              <button className="block w-full text-left px-4 py-2 hover:bg-gray-100 text-red-600" onClick={handleLogout}>Logout</button>
            </div>
          )}
        </div>
      </div>
